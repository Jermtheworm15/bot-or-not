...
import AIForensicsLab from './pages/AIForensicsLab';
...
const AuthenticatedApp = () => {
  ...
  return (
    <Routes>
      ...
      <Route path="/AIForensicsLab" element={<LayoutWrapper currentPageName="AIForensicsLab"><AIForensicsLab /></LayoutWrapper>} />
