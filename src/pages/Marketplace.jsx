    ...
    <div className="min-h-screen bg-black text-green-400 p-4 pb-32 overflow-y-auto">
      <div className="max-w-6xl mx-auto">
        <div className="flex items-center justify-between mb-6">
          ...
          {myWallet && (
            <Link to="/Wallet" className="bg-purple-900/30 border border-purple-500/30 rounded-lg px-4 py-2 hover:bg-purple-900/50 transition-colors cursor-pointer">
              ...
              <div className="p-2 md:p-4">
                ...
                <div className="flex items-center justify-between mt-2 md:mt-4">
                  ...
                  <Button
                    ...
                    size="sm"
                    className="bg-purple-600 hover:bg-purple-700 text-xs md:text-sm cursor-pointer disabled:cursor-not-allowed"
                  >
                    {listing.seller_email === user?.email ? 'Yours' : 'Buy'}
                  </Button>
                </div>
              </div>
            </Card>
