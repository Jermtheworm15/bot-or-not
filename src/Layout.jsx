      ...
      {isMobile && (
        <nav className="fixed bottom-0 left-0 right-0 z-50 bg-black/80 backdrop-blur-md border-t-2 border-purple-500/30 neon-glow">
          <div className="flex justify-between items-center px-4 py-3 gap-2">
            <Link to={createPageUrl('Home')} className={`flex flex-col items-center gap-1 py-2 px-4 rounded-lg font-medium transition-all flex-1 ${currentPageName === 'Home' ? 'bg-purple-600 text-white shadow-lg shadow-purple-500/50' : 'text-green-400 hover:text-white hover:bg-purple-900/30'}`}><Eye className="w-5 h-5" /><span className="text-xs uppercase tracking-wide">Vote</span></Link>
            <Link to={createPageUrl('Upload')} className={`flex flex-col items-center gap-1 py-2 px-4 rounded-lg font-medium transition-all flex-1 ${currentPageName === 'Upload' ? 'bg-purple-600 text-white shadow-lg shadow-purple-500/50' : 'text-green-400 hover:text-white hover:bg-purple-900/30'}`}><Upload className="w-5 h-5" /><span className="text-xs uppercase tracking-wide">Upload</span></Link>
            <Link to={createPageUrl('Profile')} className={`flex flex-col items-center gap-1 py-2 px-4 rounded-lg font-medium transition-all flex-1 ${currentPageName === 'Profile' ? 'bg-purple-600 text-white shadow-lg shadow-purple-500/50' : 'text-green-400 hover:text-white hover:bg-purple-900/30'}`}><User className="w-5 h-5" /><span className="text-xs uppercase tracking-wide">Profile</span></Link>
            <Sheet open={isMenuOpen} onOpenChange={setIsMenuOpen}>
              <SheetTrigger asChild>
                <button className="flex flex-col items-center gap-1 py-2 px-4 rounded-lg font-medium transition-all flex-1 text-green-400 hover:text-white hover:bg-purple-900/30">
                  <Menu className="w-5 h-5" />
                  <span className="text-xs uppercase tracking-wide">More</span>
                </button>
              </SheetTrigger>
              <SheetContent side="bottom" className="bg-zinc-900 border-purple-500/30">
                <div className="grid grid-cols-2 gap-2 pt-4">
                  <Link to={createPageUrl('UserLeaderboard')} onClick={() => setIsMenuOpen(false)} className="flex flex-col items-center gap-2 py-4 px-3 rounded-lg bg-zinc-800 hover:bg-purple-900/30 transition-all"><Trophy className="w-6 h-6 text-purple-400" /><span className="text-xs uppercase tracking-wide text-green-400">Leaderboard</span></Link>
                  <Link to={createPageUrl('StreakLeaderboard')} onClick={() => setIsMenuOpen(false)} className="flex flex-col items-center gap-2 py-4 px-3 rounded-lg bg-zinc-800 hover:bg-purple-900/30 transition-all"><Flame className="w-6 h-6 text-orange-400" /><span className="text-xs uppercase tracking-wide text-green-400">Streaks</span></Link>
                  <Link to={createPageUrl('AITools')} onClick={() => setIsMenuOpen(false)} className="flex flex-col items-center gap-2 py-4 px-3 rounded-lg bg-zinc-800 hover:bg-purple-900/30 transition-all"><Wand2 className="w-6 h-6 text-blue-400" /><span className="text-xs uppercase tracking-wide text-green-400">AI Tools</span></Link>
                  <Link to={createPageUrl('Achievements')} onClick={() => setIsMenuOpen(false)} className="flex flex-col items-center gap-2 py-4 px-3 rounded-lg bg-zinc-800 hover:bg-purple-900/30 transition-all"><Trophy className="w-6 h-6 text-amber-400" /><span className="text-xs uppercase tracking-wide text-green-400">Achieve</span></Link>
                  <Link to={createPageUrl('AIChallenge')} onClick={() => setIsMenuOpen(false)} className="flex flex-col items-center gap-2 py-4 px-3 rounded-lg bg-zinc-800 hover:bg-purple-900/30 transition-all"><Gamepad2 className="w-6 h-6 text-pink-400" /><span className="text-xs uppercase tracking-wide text-green-400">AI Battle</span></Link>
                  <Link to={createPageUrl('Community')} onClick={() => setIsMenuOpen(false)} className="flex flex-col items-center gap-2 py-4 px-3 rounded-lg bg-zinc-800 hover:bg-purple-900/30 transition-all"><Users className="w-6 h-6 text-cyan-400" /><span className="text-xs uppercase tracking-wide text-green-400">Board</span></Link>
                  <Link to={createPageUrl('Referrals')} onClick={() => setIsMenuOpen(false)} className="flex flex-col items-center gap-2 py-4 px-3 rounded-lg bg-zinc-800 hover:bg-purple-900/30 transition-all"><Users className="w-6 h-6 text-green-400" /><span className="text-xs uppercase tracking-wide text-green-400">Refer</span></Link>
                  <Link to={createPageUrl('AttributeGame')} onClick={() => setIsMenuOpen(false)} className="flex flex-col items-center gap-2 py-4 px-3 rounded-lg bg-zinc-800 hover:bg-purple-900/30 transition-all"><Sparkles className="w-6 h-6 text-yellow-400" /><span className="text-xs uppercase tracking-wide text-green-400">Attribute</span></Link>
                  <Link to={createPageUrl('AttributeLeaderboard')} onClick={() => setIsMenuOpen(false)} className="flex flex-col items-center gap-2 py-4 px-3 rounded-lg bg-zinc-800 hover:bg-purple-900/30 transition-all"><Trophy className="w-6 h-6 text-red-400" /><span className="text-xs uppercase tracking-wide text-green-400">AttrRank</span></Link>
                  <Link to={createPageUrl('Analytics')} onClick={() => setIsMenuOpen(false)} className="flex flex-col items-center gap-2 py-4 px-3 rounded-lg bg-zinc-800 hover:bg-purple-900/30 transition-all"><TrendingUp className="w-6 h-6 text-green-400" /><span className="text-xs uppercase tracking-wide text-green-400">Analytics</span></Link>
                </div>
              </SheetContent>
            </Sheet>
          </div>
