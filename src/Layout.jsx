...
import { Trophy, Upload, Flame, Eye, User, Users, Gamepad2, Wand2, Sparkles, Menu, X, ChevronLeft, MessageCircle, Home, Settings, LogOut, Gauge } from 'lucide-react';
        ...
        {!isMobile && (
          <nav className="fixed bottom-0 left-0 right-0 z-50 bg-black/80 backdrop-blur-md border-t-2 border-purple-500/30 neon-glow"
            ...
            <div className="w-full px-2 py-3">
              ...
              <Link to={createPageUrl('Challenges')} className={`flex flex-1 flex-col items-center justify-center gap-1 py-3 font-medium transition-all ${currentPageName === 'Challenges' || currentPageName === 'AIChallenge' ? 'bg-purple-600 text-white shadow-lg shadow-purple-500/50' : 'text-green-400 hover:text-white hover:bg-purple-900/30'}`}><Gamepad2 className="w-5 h-5" /><span className="text-xs uppercase tracking-wide">Battle</span></Link>
              <Link to={createPageUrl('Community')} className={`flex flex-1 flex-col items-center justify-center gap-1 py-3 font-medium transition-all ${currentPageName === 'Community' || currentPageName === 'Messages' ? 'bg-purple-600 text-white shadow-lg shadow-purple-500/50' : 'text-green-400 hover:text-white hover:bg-purple-900/30'}`}><Users className="w-5 h-5" /><span className="text-xs uppercase tracking-wide">Social</span></Link>
