        ...
        {!isMobile && (
          <nav className="fixed bottom-0 left-0 right-0 z-50 bg-black/80 backdrop-blur-md border-t-2 border-purple-500/30 neon-glow"
            ...
            <div className="w-full px-2 py-3">
              ...
              <Link to={createPageUrl('Home')} className={`flex-shrink-0 flex flex-col items-center gap-1 py-2 px-4 rounded-lg font-medium transition-all whitespace-nowrap ${currentPageName === 'Home' ? 'bg-purple-600 text-white shadow-lg shadow-purple-500/50' : 'text-green-400 hover:text-white hover:bg-purple-900/30'}`}><Eye className="w-5 h-5" /><span className="text-xs uppercase tracking-wide">Vote</span></Link>
              <Link to={createPageUrl('UserLeaderboard')} className={`flex-shrink-0 flex flex-col items-center gap-1 py-2 px-4 rounded-lg font-medium transition-all whitespace-nowrap ${currentPageName === 'UserLeaderboard' || currentPageName === 'StreakLeaderboard' ? 'bg-purple-600 text-white shadow-lg shadow-purple-500/50' : 'text-green-400 hover:text-white hover:bg-purple-900/30'}`}><Trophy className="w-5 h-5" /><span className="text-xs uppercase tracking-wide">Ranks</span></Link>
              <Link to={createPageUrl('Challenges')} className={`flex-shrink-0 flex flex-col items-center gap-1 py-2 px-4 rounded-lg font-medium transition-all whitespace-nowrap ${currentPageName === 'Challenges' || currentPageName === 'AIChallenge' ? 'bg-purple-600 text-white shadow-lg shadow-purple-500/50' : 'text-green-400 hover:text-white hover:bg-purple-900/30'}`}><Gamepad2 className="w-5 h-5" /><span className="text-xs uppercase tracking-wide">Battle</span></Link>
              <Link to={createPageUrl('Community')} className={`flex-shrink-0 flex flex-col items-center gap-1 py-2 px-4 rounded-lg font-medium transition-all whitespace-nowrap ${currentPageName === 'Community' || currentPageName === 'Messages' ? 'bg-purple-600 text-white shadow-lg shadow-purple-500/50' : 'text-green-400 hover:text-white hover:bg-purple-900/30'}`}><Users className="w-5 h-5" /><span className="text-xs uppercase tracking-wide">Social</span></Link>
              <Link to={createPageUrl('Profile')} className={`flex-shrink-0 flex flex-col items-center gap-1 py-2 px-4 rounded-lg font-medium transition-all whitespace-nowrap ${currentPageName === 'Profile' ? 'bg-purple-600 text-white shadow-lg shadow-purple-500/50' : 'text-green-400 hover:text-white hover:bg-purple-900/30'}`}><User className="w-5 h-5" /><span className="text-xs uppercase tracking-wide">Profile</span></Link>
            </div>
          </div>
        </nav>
      )}
